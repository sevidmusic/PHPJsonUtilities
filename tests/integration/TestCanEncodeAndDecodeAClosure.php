 ...
 *
 * Test that Closures can be encoded as json via a Json instance, and
 * that a Json instance used to encode an Closure can be decoded back
...
if(
    is_object($decodedClosure)
    &&
    $decodedClosure::class === $closure->value()::class
) {
